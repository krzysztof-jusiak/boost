...
rec_pow_2<long, int, 100000000000000000L>::data[] = {
	...
	58711242675781250L, 71054273576010018L  /* 47 */
};
...
rec_pow_2<long, int, 100000000L>::data[] = {
	...
	50000000L, 26757812L, 85871124L, 57601001L, 71054273L  /* 47 */
};

template <>
rec_pow_2<long, int, 100000000L>::selector_type const
rec_pow_2<long, int, 100000000L>::selector[] = {
	0, 1, 2, 3, 4, 6, 8, 10, 13, 16, 19, 22, 26, 30, 34, 39, 44
};

template <>
std::size_t const
rec_pow_2<long, int, 100000000L>::size = 16;
