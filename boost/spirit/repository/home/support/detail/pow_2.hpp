...
template <>
std::size_t const
pow_2<long, int, 1000000000000000000L>::size = 15;
...
pow_2<long, int, 100000000L>::data[] = {
	...
	83886080L, /* 23 */
	67108864L, /* 26 */
	53687091L, 20000000L, /* 29 */
	85899345L, 92000000L, /* 33 */
	68719476L, 73600000L, /* 36 */
	54975581L, 38880000L, /* 39 */
	87960930L, 22208000L, /* 43 */
	70368744L, 17766400L  /* 46 */
};
...
template <>
std::size_t const
pow_2<long, int, 100000000L>::size = 15;
