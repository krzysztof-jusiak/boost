...
template <>
std::size_t const
pow_2m1<long, int, 100000000000000000L>::size = 15;
...
pow_2m1<long, int, 100000000L>::data[] = {
	...
	83886070L, /* 23 */
	67108863L, /* 26 */
	53687091L, 10000000L, /* 29 */
	85899345L, 91000000L, /* 33 */
	68719476L, 73500000L, /* 36 */
	54975581L, 38870000L, /* 39 */
	87960930L, 22207000L, /* 43 */
	70368744L, 17766300L  /* 46 */
};
...
template <>
std::size_t const
pow_2m1<long, int, 100000000L>::size = 15;
